    ...
    async execute(client, message, args, Discord){
        ...
        try {
            ...
            .addFields(
                ...
                {name: 'Caldera Quads Gulag Ws', value: data.data.weekly.mode.br_brquads.properties.gulagKills.toString(), inline: true},
                {name: 'Caldera Quads Gulag Ls', value: data.data.weekly.mode.br_brquads.properties.gulagDeaths.toString(), inline: true},
                { name: '\u200B', value: '\u200B' }
            )
